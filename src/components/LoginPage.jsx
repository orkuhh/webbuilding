...
export default function LoginPage() {
  ...
  const { signIn, signInWithDiscord, signInWithGoogle, loading, error } = useAuth();
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm text-division-orange hover:text-division-orange/80">
          ...
          <div className="text-center">
            <p className="text-gray-400">
              ...
              <Link to="/register" className="text-division-orange hover:text-division-orange/80">
                Sign up
              </Link>
            </p>
          </div>
